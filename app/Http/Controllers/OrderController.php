...
class OrderController extends Controller
{
    ...
    {
        $orders = Order::with('customer')->where('status', 'Dikonfirmasi')->get();
    ...
    {
        $orders = Order::with('customer')->where('status', 'Dikemas')->get();
    ...
    {
        $orders = Order::with('customer')->where('status', 'Dikirim')->get();
    ...
    {
        $orders = Order::with('customer')->where('status', 'Diterima')->get();
    ...
    {
        $orders = Order::with('customer')->where('status', 'Selesai')->get();
