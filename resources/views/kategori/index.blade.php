        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-label">Form Kategori</h5>
                ...
                success: function({
                    ...
                    data.map(function(val, index) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#modal-form" data-id="${val.id}" class="btn btn-warning modal-ubah"><i class="fas fa-cog"></i></a>
                                <a href="#" data-id="${val.id}" class="btn btn-danger btn-hapus"><i class="fas fa-trash"></i></a>
                                </td>
                            </td>
                        </tr>
                        `;
