                                ...
                                <div class="logo-container">
                                    <div class="logo-wrap">
                                        <a href="/">
                                            ...
                                            @endphp
                                            <img class="logo-dark2" src="/uploads/{{ $about?->logo }}" width="50"
                                                height="50" alt="logo">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <ul>
                                    <li class="nav-register">
                                        @if (Auth::guard('webcustomer')->check())
                                            <a href="/profile">{{ Auth::guard('webcustomer')->user()->nama_customer }}
                                            </a>
                                        @else
                                            <a href="/login_customer">Masuk </a>
                                        @endif
                                    </li>
                                    ...
                                    <li class="nav-register">
                                        @if (Auth::guard('webcustomer')->check())
                                            <a href="/logout_customer">Keluar</a>
                                        @endif
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    <img class="logo-dark2" src="/uploads/{{ $about?->logo }}" width="100"
                                        height="100" alt="logo">
                                    <p class="mb-30">Keripik Salakinaja Camilan Sehat Oleh-oleh Khas Lumajang</p>
                            ...
                            <div class="col-md-2 col-md-offset-1 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        <li><a href="/front/#">Toko Kami</a></li>
                                        <li><a href="/front/#">Tentang Kami</a></li>
                                        <li><a href="/front/#">Bisnis Dengan Kami</a></li>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        ...
                                        <li><a href="/cart">Daftar Keinginan</a></li>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        ...
                                        <li><a href="/front/#">Syarat &amp; Ketentuan</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        <li><a href="/about">Pendukung</a></li>
                                        <li><a href="/about">Jaminan</a></li>
